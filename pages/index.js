...
<ul className="pl-4 pb-4" style={{ margin: '0px', padding: '0px' }}> {/* Adjust the margin and padding */}
  <li style={{ display: 'flex', alignItems: 'center', marginBottom: '0px' }}> {/* Negative margin to reduce space */}
    <div style={{ display: 'flex', alignItems: 'center', border: '1.5px solid #000', padding: '2px', borderRadius: '5px', marginTop: '1px', marginBottom: '0px', marginLeft: '-5px' }}>
      <UserIcon2 />
  ...
  <li style={{ display: 'flex', alignItems: 'center', marginTop: '0px' }}> {/* Negative margin to reduce space */}
    <div style={{ display: 'flex', alignItems: 'center', padding: '2px', marginTop: '1px', marginBottom: '0px', marginLeft: '-6x' }}> {/* Removed border */}
      <Icon3 />
